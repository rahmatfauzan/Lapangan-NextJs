...
const LoginForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent): Promise<void> => {
    ...
    try {
      ...
      // Mock validation
      if (email === "admin@gomabar.com" && password === "admin123") {
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onKeyDown={(e) => e.key === "Enter" && handleFormSubmit(e)}
                  disabled={isLoading}
                  className="w-full pl-12 pr-12 py-3 border-2 border-gray-200 rounded-xl focus:border-orange-500 focus:outline-none transition-all disabled:bg-gray-50 disabled:cursor-not-allowed"
                />
                <button
                  type="button"
